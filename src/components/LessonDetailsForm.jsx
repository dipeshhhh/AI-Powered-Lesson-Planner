...
import { GENERATED_LESSON_DETAILS_FORM_ENUM, INPUT_LESSON_DETAILS_FORM_ENUM, RECENT_USER_INPUTS_LOCAL_STORAGE_KEY } from "@/lib/constants.js"
...
export default function LessonDetailsForm({ lessonDetails, setLessonDetails, type }) {
  ...
  const handleGenerateLessonPlan = async (e) => {
    ...
    // show user result and check for correct JSON formatting.
    // validate properties in the JSON and handle missing properties.
    ...
    // build form if JSON parsing success.
    // set Loading false
    // render form.
  }
